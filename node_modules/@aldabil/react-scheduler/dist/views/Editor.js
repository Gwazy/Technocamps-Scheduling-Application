...
const initialState = (fields, event) => {
  ...
  for (const field of fields) {
    ...
    const eveVal = arraytizeFieldVal(
      field,
      event === null || event === void 0 ? void 0 : event[field.name],
      event
    );
    customFields[field.name] = {
      value: eveVal.value || defVal.value || "",
      validity: (
        (_a = field.config) === null || _a === void 0 ? void 0 : _a.required
      )
  ...
  return Object.assign(
    {
      event_id: {
        value:
          (event === null || event === void 0 ? void 0 : event.event_id) ||
          null,
        validity: true,
        type: "hidden",
      },
      ...
      start: {
        value:
          (event === null || event === void 0 ? void 0 : event.start) ||
          new Date(),
        validity: true,
        type: "date",
...
const Editor = () => {
  ...
  const handleEditorState = (name, value, validity) => {
    setState((prev) => {
      return Object.assign(Object.assign({}, prev), {
        [name]: Object.assign(Object.assign({}, prev[name]), {
          value,
          validity,
        }),
      });
  ...
  const handleConfirm = () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        ...
        body.end =
          body.start >= body.end
            ? addMinutes(
                body.start,
                differenceInMinutes(
                  selectedRange === null || selectedRange === void 0
                    ? void 0
                    : selectedRange.end,
                  selectedRange === null || selectedRange === void 0
                    ? void 0
        ...
        // Specify action
        const action = (
          selectedEvent === null || selectedEvent === void 0
            ? void 0
              ...
              { style: { overflowX: "hidden" } },
              {
                children: _jsx(
                  ...
                  Object.assign(
                    ...
                    {
                      children: Object.keys(state).map((key) => {
                        var _a;
                          ...
                          Object.assign(
                            {
                              item: true,
                              sm:
                                (_a = item.config) === null || _a === void 0
                                  ? void 0
                                  : _a.sm,
                              xs: 12,
                            },
                            { children: renderInputs(key) }
                          ),
                          key
                        );
                      }),
  ...
  return _jsx(
    Dialog,
    Object.assign(
      { open: dialog, fullScreen: isMobile, maxWidth: dialogMaxWidth },
